...
class MatchGame extends Component {
  ...
  displayRandomImage = () => {
    ...
    const index = Math.floor(Math.random() * imagesListLength)

    return imagesList[index]
  }

  onClickThumbnailBtn = id => {
    const {dipslayImageUrl} = this.state

    if (dipslayImageUrl.id === id) {
      this.setState({dipslayImageUrl: this.displayRandomImage()})
  ...
  render() {
      ...
      <>
        <div className="main-container">
          <div className="display-image-container">
            <img
              src={dipslayImageUrl.imageUrl}
              alt="match"
              className="display-image"
            />
          </div>
          <div>
            <ul className="ul-tabItems">
    ...
    const renderResult = () => (
      <div className="result-container-component">
        <Result
        ...
        <nav className="header-section">
          ...
          <ul className="score-and-time-container">
            ...
            <div className="timer-container">
              ...
              />
              <li className="nav-list-style">
                <p className="live-score">{timeInSec} Sec</p>
              </li>
            </div>
          </ul>
        </nav>
        {/* main-container */}
        {isGameOver ? renderResult() : renderGame()}
      </div>
    )
  }
}
